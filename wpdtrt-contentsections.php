 ...
 * @since     0.7.0
 */
  define( 'WPDTRT_CONTENTSECTIONS_VERSION', '0.0.1' );
}
 ...
 */
  ...
  require_once(WPDTRT_CONTENTSECTIONS_PATH . 'vendor/dotherightthing/wpdtrt-plugin/index.php');
    ...
    $wpdtrt_contentsections_plugin = new WPDTRT_Contentsections_Plugin(
      array(
        ...
        'messages' => array(
          ...
          'noscript_warning' => __('JavaScript is disabled. Please enable JavaScript to load demo data.', 'wpdtrt-contentsections'),
